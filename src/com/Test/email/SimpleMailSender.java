...
public class SimpleMailSender {
	...
	public static void main(String[] args) {
		...
		mailInfo.setUserName("chinawphuang@126.com");
		mailInfo.setPassword("kqxzlqjg215");// 您的邮箱密码
		mailInfo.setFromAddress("chinawphuang@126.com");
		String[] to = {"331337390@qq.com"};
		mailInfo.setToAddress(to);
		//String[] toCC = {"331337390@qq.com"};
		//mailInfo.setToCarbonCopyAddress(toCC);
		//String[] toBCC = {"331337390@qq.com"};
		...
		// 这个类主要来发送邮件
		System.out.println(SimpleMailSender.sendMail(mailInfo));;//发送文体格式
	}
}
